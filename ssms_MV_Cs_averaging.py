...
# filenames = glob.glob('MVdata/MV_Cs_0*.csv') + glob.glob('MVdata/MV_Cs_3*.csv') # number of data = 47
filenames = glob.glob('MVdata_P2/MV_Cs_3*.csv') # + glob.glob('MVdata/MV_Cs_3*.csv') # number of data = 47
xs=[]
ys=[]
j=0
